export default class LSentenceInstrScene extends Phaser.Scene {
    constructor() {
        super("LSentenceInstrScene");
        this.width = 0;
        this.height = 0;
    }
    ...
    preload() {
        ...
        this.load.image('riko-with-flower', 'assets/images/riko-with-flower.png');
        this.load.image('instr-l-sentence', 'assets/images/instr-l-sentence.png');
    ...
    create() {
        ...
        const RikoWithFlower = this.add.image(this.width / 2.8, this.height - 200, 'riko-with-flower')
        .setScale(0.5)
        .setDepth(1);


        const InstrLSound = this.add.image(this.width / 1.4, this.height / 2, 'instr-l-sentence')
        .setScale(0.55)
        .setDepth(1);
