export default class LSoundInstrScene extends Phaser.Scene {
    constructor() {
        super("LSoundInstrScene");
        this.width = 0;
        this.height = 0;
    }
    ...
    preload() {
        ...
        this.load.image('riko-with-l-balloons', 'assets/images/riko-with-l-balloons.png');
        this.load.image('instr-l-sound', 'assets/images/instr-l-sound.png');
    ...
    create() {
        ...
        const RikoWithLBalloons = this.add.image(this.width / 2.8, this.height - 230, 'riko-with-l-balloons')
        .setScale(0.4)
        .setDepth(1);


        const InstrLSound = this.add.image(this.width / 1.4, this.height / 2, 'instr-l-sound')
        .setScale(0.55)
        .setDepth(1);
